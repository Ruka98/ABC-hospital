...
export default async function DoctorPage() {
  ...
  const nurses = await dbAll("SELECT * FROM staff WHERE role = 'nurse' AND is_available = true ORDER BY name") as any[]

  // Get available radiologists
  const radiologists = await dbAll("SELECT * FROM staff WHERE role = 'radiologist' AND is_available = true ORDER BY name") as any[]
